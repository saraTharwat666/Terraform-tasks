...
Create a Kinesis Stream: Provision a stream named devops-dev-stream with 1 shard and a 24-hour retention policy.

Create an S3 Bucket: Create a bucket named devops-dev-30907.
